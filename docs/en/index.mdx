...
<CardGroup cols={2}>
  ...
  <Card title="Intelligent Tool Search" icon="search" href="/en/concepts/tool-search">
    Dynamically discover and load relevant tools with built-in search. Optimize context windows and scale to large tool catalogs.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Tool Search" icon="search" href="/en/concepts/tool-search">
    Dynamically discover tools on-demand with intelligent search capabilities.
  </Card>
  ...
  <Card title="Inspector" icon="search-code" href="/en/concepts/inspector">
    Test and debug your MCP endpoints with the built-in inspector.
  </Card>
</CardGroup>
